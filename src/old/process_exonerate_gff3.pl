...
##from https://github.com/hyphaltip/genome-scripts/blob/master/data_format/process_exonerate_gff3.pl
##From exonerate to igv: A story about GFF - https://github.com/alvaralmstedt/Tutorials/wiki/From-exonerate-to-igv:-A-story-about-GFF
